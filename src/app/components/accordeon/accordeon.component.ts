...
export class AccordeonComponent {
  items = [
    {
      question: 'What is Yin-Style Yoga?',
      answer:
    ...
    {
      question: 'Basic Principles of Yin-Style Yoga',
      answer:
    ...
    {
      question: 'Benefits of Yin-Style Yoga',
      answer:
    ...
    {
      question: 'Safety Tips for Practicing Yin-Style Yoga',
      answer:
